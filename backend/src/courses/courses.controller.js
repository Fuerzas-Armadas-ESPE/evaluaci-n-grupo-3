...
var CoursesController = function () {
    ...
    var CoursesController = _classThis = /** @class */ (function () {
        function CoursesController_1(courseService) {
        ...
        CoursesController_1.prototype.getAllCourses = function () {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.courseService.getAllCourses()];
                        case 1: return [2 /*return*/, _a.sent()];
                    }
                });
            });
        };
        CoursesController_1.prototype.getCourse = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                var error_1;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            return [4 /*yield*/, this.courseService.getCourse(id)];
                        case 1: return [2 /*return*/, _a.sent()];
                        case 2:
                            error_1 = _a.sent();
        ...
        CoursesController_1.prototype.createCourse = function (courseData) {
            return __awaiter(this, void 0, void 0, function () {
                var error_2;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            return [4 /*yield*/, this.courseService.createCourse(courseData)];
                        case 1: return [2 /*return*/, _a.sent()];
                        case 2:
                            error_2 = _a.sent();
                            throw new common_1.InternalServerErrorException();
        ...
        CoursesController_1.prototype.updateCourse = function (id, courseData) {
            return __awaiter(this, void 0, void 0, function () {
                var error_3;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            return [4 /*yield*/, this.courseService.updateCourse(id, courseData)];
                        case 1: return [2 /*return*/, _a.sent()];
                        case 2:
                            error_3 = _a.sent();
                            throw new common_1.InternalServerErrorException();
        ...
        CoursesController_1.prototype.deleteCourse = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                var error_4;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            return [4 /*yield*/, this.courseService.deleteCourse(id)];
                        case 1:
                            _a.sent();
                            return [3 /*break*/, 3];
                        case 2:
    ...
    (function () {
        ...
        _getCourse_decorators = [(0, common_1.Get)(':id')];
        ...
        __esDecorate(_classThis, null, _getCourse_decorators, { kind: "method", name: "getCourse", static: false, private: false, access: { has: function (obj) { return "getCourse" in obj; }, get: function (obj) { return obj.getCourse; } }, metadata: _metadata }, null, _instanceExtraInitializers);
